    ...
    public partial class AltasRecepcionista : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool entro = false;
                MySqlCommand cono = new MySqlCommand(String.Format("select * from recepcionista where curp = '{0}'", txtCurp.Text), conexion.obtenerConexion());
                ...
                if(entro == false)
                {
                    ...
                    {
                        MessageBox.Show("Fuera del rango de edad - 22 años");
                    }
